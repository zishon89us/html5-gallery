...
function join(array, success, failure) {

    return $.when.apply(null, array).then(function () {
        success(arguments);
    }, function () {
        failure(arguments);
    })
...
sampleApp.factory('topicsdb', function(pouchdb, $rootScope, $q) {
    return {
        ...
        saveList:function(topicList, success, failure) {
            ...
            return join(_promises, success, failure);
