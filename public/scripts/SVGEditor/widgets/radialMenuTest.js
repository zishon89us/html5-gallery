    ...
    var RadialMenu = WinJS.Class.define(function (d3SvgContainer, cx, cy, radius, menuData, menuID, mainCenterSpot, theme, menuSelectedFn, groupSelectionBindingFn, stateManager) {
        ...
        },
        {
            ...
            drawMainCircle: function (menuData) {
                ...
                var centerSpotG = this.mainG.append("g").on(centerSpotEvent, function () {//Zeeshan Hassan code changed
                    //console.log( "Radia >>>>> Yes on mouse up" );
                    var evt = d3.event;//Zeeshan Hassan code added
                    //evt.stopPropagation();////Zeeshan Hassan code added
                ...
                }).classed("radialMenuCenterSpot", true);//Zeeshan Hassan code added
            ...
            draw: function ( menuData ) {
                ...
                var g = this.mainG.selectAll( ".arc" )
                    ...
                    .on( "pointerdown", function ( d ) {//Zeeshan Hassan code changed
                    ...
                    } ).classed( "outerArc", true );//Zeeshan Hassan code added
                ...
                var mainG2 = this.mainG.append( "g" ).classed( "innerArc", true );//Zeeshan Hassan code added
                //.attr("transform", "translate(" + this.cx + "," + this.cy + ")");
                ...
                // ********
                    ...
                    g2.on( "pointerdown", function ( d ) {//Zeeshan Hassan code added
                        ...
                        var evt = d3.event;//Zeeshan Hassan code added
                        evt.stopPropagation();////Zeeshan Hassan code added
                        evt.preventDefault();      //code added by Zeeshan
                        ...
                        setTimeout( function () {
                            if ( d.data.childMenu ) {
                                ...
                                else {     //moved the code by Zeeshan
                                    //d.data.childMenu.parentMenu = menuData;
                                    //that.clearChildren();
                                    //that.drawMainCircle( d.data.childMenu );
                                    //that.draw( d.data.childMenu );
